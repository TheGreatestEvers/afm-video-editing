## Most parts taken from 2017 Intel Corporation.
...
subfolder_depth = os.path.join(script_dir, f"{timestamp_folder}/depth")
subfolder_rgb = os.path.join(script_dir, f"{timestamp_folder}/rgb")
    ...
    while True:
        ...
        if key & 0xFF == ord(" "):
            if not RecordStream:
                ...
                with open(os.path.join(script_dir, f"{timestamp_folder}/cam_K.txt"), "w") as f:
